...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/pgpy-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=13705&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/pgpy-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `pgpy` can be installed with:

```
conda install pgpy
```

It is possible to list all of the versions of `pgpy` available on your platform with:
